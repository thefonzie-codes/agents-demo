...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-google-surface font-sans">
      {/* Header - Google style: white with subtle border */}
      <header className="bg-google-surface border-b border-google-border px-6 py-3 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          {/* Google-style multi-color icon */}
          ...
          <h1 className="text-lg font-medium text-google-text">
            Travel Agent
          </h1>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-google-blue text-sm font-medium rounded-full hover:bg-google-blue-light transition-colors cursor-pointer"
        >
